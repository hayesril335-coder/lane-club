...
export default function OrdersPage({ alley }) {
  ...
  return <main className="orders-page"><section>
    <p>STORE ORDERS</p><div className="orders-heading"><div><h1>Customer <em>orders.</em></h1><span>Orders placed by owners and connected employees appear here.</span></div><strong>{orders.length} total</strong></div>

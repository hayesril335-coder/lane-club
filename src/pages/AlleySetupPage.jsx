  ...
  return <main className="setup-page">
    ...
    <div className="setup-shell">
      ...
      <section className="setup-form-area"><form onSubmit={submit} className="setup-form">
        ...
        <div className="field-grid"><label>Number of lanes<input type="number" min="1" max="100" value={lanes} onChange={(e) => setLanes(e.target.value)} /></label><label>Lane name format<select defaultValue="Lane"><option>Lane 1, Lane 2, Lane 3...</option><option>Custom lane names</option></select></label><label>Weekday opening time<select defaultValue="11:00 AM"><option>9:00 AM</option><option>10:00 AM</option><option>11:00 AM</option><option>12:00 PM</option></select></label><label>Weekday closing time<select defaultValue="11:00 PM"><option>9:00 PM</option><option>10:00 PM</option><option>11:00 PM</option><option>12:00 AM</option></select></label></div>

...
export default function LeagueSetupPage({ alley, initialLeagueId, managementOnly = false, onBack, onSaveLeague, onUpdateLeague, onDeleteLeague, onEndMembership }) {
  ...
  useEffect(() => { setEditing(false); setConfirmDelete(false) }, [selectedLeagueId])

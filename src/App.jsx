...
export default function App() {
  ...
  if (page === 'alley-details') return memberPage(<AlleyDetailsPage alley={selectedAlley} onBack={() => setPage('member-dashboard')} onJoin={() => hasActiveMembership() ? activateMembership() : setPage('member-checkout')} onJoinLeague={league => { setSelectedLeague(league); setPage('member-league-join') }} />, 'search')
  ...
  if (page === 'make-reservation' && !hasMembershipAt(member, selectedAlley)) return memberPage(<AlleyDetailsPage alley={selectedAlley} onBack={openMemberDashboard} onJoin={() => setPage('member-checkout')} onJoinLeague={league => { setSelectedLeague(league); setPage('member-league-join') }} />, 'search')
